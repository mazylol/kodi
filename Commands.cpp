...
void Commands::handle_language_command(const dpp::slashcommand_t *event,
...
void Commands::handle_person_command(const dpp::slashcommand_t *event,
                                     std::unordered_map<std::string, Types::Person> *people) {
...
template<typename T>
void Commands::register_command(dpp::cluster *bot, std::string *guildId, bool &prod,
                                const std::unordered_map<std::string, T> *options, const std::string &name,
...
template void Commands::register_command(dpp::cluster *bot, std::string *guildId, bool &prod,
                                         const std::unordered_map<std::string, Types::Language> *options,
                                         const std::string &name,
                                         const std::string &description, const std::string &option_name,
                                         const std::string &option_description);

template void Commands::register_command(dpp::cluster *bot, std::string *guildId, bool &prod,
                                         const std::unordered_map<std::string, Types::Person> *options,
                                         const std::string &name,
                                         const std::string &description, const std::string &option_name,
                                         const std::string &option_description);